...
4. `known_respiratory_pathogens.csv` is a curated list of organisms with known potential to cause LRTI, originally reported in a [previous publication](https://www.pnas.org/doi/10.1073/pnas.1809700115).
