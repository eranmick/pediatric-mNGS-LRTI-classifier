...
11. `11-integrated_predict_on_sus_ind` - Trains a integrated logtistic regression model on all the Definite/No Evidence samples using the host probabilities and microbial scores, and then classifies the Suspected/Indeterminate samples.
