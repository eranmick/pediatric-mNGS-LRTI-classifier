...
10. `10-host_predict_on_sus_ind` - Trains a host random forest model on all the Definite/No Evidence samples, using the genes selected from all those samples, and uses it to classify the "Suspected" and "Indeterminate" LRTI samples.
